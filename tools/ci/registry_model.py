...
def build_universal_registry() -> dict[str, Any]:
    ...
    naming_conventions = [
        ...
        },
        {
            ...
            "example": "pkgs/40_atoms/tigrbl_atoms/tests/test_sys_atoms.py -> EART-0001",
        ...
        },
        {
            ...
            "example": "pkgs/40_atoms/tigrbl_atoms/tests/test_sys_atoms.py -> TCASE-0001",
        ...
        },
        {
            ...
            "example": "pkgs/40_atoms/tigrbl_atoms/tests -> TSET-0001",
