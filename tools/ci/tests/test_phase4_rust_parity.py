...
def test_phase4_rust_parity_validator_passes() -> None:
    result = _run("tools/ci/validate_phase4_rust_parity.py")
...
def test_phase4_reports_and_ci_pointers_exist() -> None:
    ...
    assert "validate_phase4_rust_parity.py" in ci_validation
