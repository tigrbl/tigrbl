...
FEATURE_ID = "feat:rust-runtime-parity-retirement-001"
CLAIM_ID = "clm:rust-runtime-parity-retirement-001.t2"
EVIDENCE_ID = "evd:t2.rust-runtime-parity-retirement-001.proof-graph"
EXPECTED_TESTS = {
    "tst:pytest.rust-runtime-parity-retirement-001.t2.proof-graph",
    "tst:python-only-runtime-rust-executor-rejection",
    "tst:python-only-runtime-ssot-docs-rust-parity-ban",
    "tst:python-only-runtime-benchmark-rail",
...
def test_rust_runtime_parity_retirement_t2_proof_graph_is_closed() -> None:
