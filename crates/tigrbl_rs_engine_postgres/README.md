...
<p align="center">
    <a href="https://crates.io/crates/tigrbl_rs_engine_postgres">
        <img src="https://img.shields.io/crates/d/tigrbl_rs_engine_postgres" alt="crates.io downloads for tigrbl_rs_engine_postgres"/></a>
    <a href="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_engine_postgres/">
        <img src="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_engine_postgres.svg" alt="Repository views for tigrbl_rs_engine_postgres"/></a>
    <a href="https://crates.io/crates/tigrbl_rs_engine_postgres">
        <img src="https://img.shields.io/crates/v/tigrbl_rs_engine_postgres?label=tigrbl_rs_engine_postgres&color=green" alt="crates.io version for tigrbl_rs_engine_postgres"/></a>
    <a href="https://crates.io/crates/tigrbl_rs_engine_postgres">
        <img src="https://img.shields.io/crates/l/tigrbl_rs_engine_postgres" alt="crates.io license metadata for tigrbl_rs_engine_postgres"/></a>
    <a href="https://docs.rs/tigrbl_rs_engine_postgres">
        <img src="https://img.shields.io/docsrs/tigrbl_rs_engine_postgres" alt="docs.rs documentation for tigrbl_rs_engine_postgres"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_rs_engine_postgres"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_rs_engine_postgres"/></a>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_rs_engine_postgres"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_rs_engine_postgres"/></a>
</p>
---

# tigrbl_rs_engine_postgres

**Use `tigrbl_rs_engine_postgres` in Rust: [open the crate on crates.io](https://crates.io/crates/tigrbl_rs_engine_postgres) or [inspect the crate source](https://github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_engine_postgres).**

Rust Postgres engine for Tigrbl.

`tigrbl_rs_engine_postgres` is part of the Tigrbl Rust package graph. It documents crate-resident runtime, kernel, atom, port, operation, or engine behavior while cross-linking to the Python facade and sibling Rust crates.

## Crate ownership

- Rust PostgreSQL engine behavior, remote SQL sessions, and transaction boundaries.
...
```toml
[dependencies]
tigrbl_rs_engine_postgres = "0.4.0-dev.2"
```

## Package discovery

Search and AI discovery terms for `tigrbl_rs_engine_postgres` include: Tigrbl, Rust, crate, runtime, kernel, atoms, ports, engines, operations, REST, JSON-RPC, schema-first APIs.
