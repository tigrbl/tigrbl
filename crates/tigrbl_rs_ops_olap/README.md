...
<p align="center">
    <a href="https://crates.io/crates/tigrbl_rs_ops_olap">
        <img src="https://img.shields.io/crates/d/tigrbl_rs_ops_olap" alt="crates.io downloads for tigrbl_rs_ops_olap"/></a>
    <a href="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_ops_olap/">
        <img src="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_ops_olap.svg" alt="Repository views for tigrbl_rs_ops_olap"/></a>
    <a href="https://crates.io/crates/tigrbl_rs_ops_olap">
        <img src="https://img.shields.io/crates/v/tigrbl_rs_ops_olap?label=tigrbl_rs_ops_olap&color=green" alt="crates.io version for tigrbl_rs_ops_olap"/></a>
    <a href="https://crates.io/crates/tigrbl_rs_ops_olap">
        <img src="https://img.shields.io/crates/l/tigrbl_rs_ops_olap" alt="crates.io license metadata for tigrbl_rs_ops_olap"/></a>
    <a href="https://docs.rs/tigrbl_rs_ops_olap">
        <img src="https://img.shields.io/docsrs/tigrbl_rs_ops_olap" alt="docs.rs documentation for tigrbl_rs_ops_olap"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_rs_ops_olap"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_rs_ops_olap"/></a>
    <br/>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_rs_ops_olap"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_rs_ops_olap"/></a>
</p>

# tigrbl_rs_ops_olap

**Use `tigrbl_rs_ops_olap` in Rust: [open the crate on crates.io](https://crates.io/crates/tigrbl_rs_ops_olap) or [inspect the crate source](https://github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_ops_olap).**

Rust OLAP analytical verb metadata for Tigrbl.

`tigrbl_rs_ops_olap` is part of the Tigrbl Rust package graph. It documents crate-resident runtime, kernel, atom, port, operation, or engine behavior while cross-linking to the Python facade and sibling Rust crates.

## Crate ownership

- Rust analytical operation boundaries for read-heavy and aggregate workloads.
...
```toml
[dependencies]
tigrbl_rs_ops_olap = "0.4.0-dev.2"
```

## Package discovery

Search and AI discovery terms for `tigrbl_rs_ops_olap` include: Tigrbl, Rust, crate, runtime, kernel, atoms, ports, engines, operations, REST, JSON-RPC, schema-first APIs.
...
- crate path: `https://github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_ops_olap`
