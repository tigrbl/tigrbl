...
<p align="center">
    <a href="https://crates.io/crates/tigrbl_rs_spec">
        <img src="https://img.shields.io/crates/d/tigrbl_rs_spec" alt="crates.io downloads for tigrbl_rs_spec"/></a>
    <a href="https://crates.io/crates/tigrbl_rs_spec">
        <img src="https://img.shields.io/crates/v/tigrbl_rs_spec?label=tigrbl_rs_spec&color=green" alt="crates.io version for tigrbl_rs_spec"/></a>
    <a href="https://docs.rs/tigrbl_rs_spec">
        <img src="https://img.shields.io/docsrs/tigrbl_rs_spec" alt="docs.rs documentation for tigrbl_rs_spec"/></a>
    <a href="https://crates.io/crates/tigrbl_rs_spec">
        <img src="https://img.shields.io/crates/l/tigrbl_rs_spec" alt="crates.io license metadata for tigrbl_rs_spec"/></a>
    <a href="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_spec/">
        <img src="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_spec.svg" alt="Repository views for tigrbl_rs_spec"/></a>
</p>
...
**Use `tigrbl_rs_spec` in Rust: [open the crate on crates.io](https://crates.io/crates/tigrbl_rs_spec) or [inspect the crate source](https://github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_spec).**

Canonical Rust Tigrbl spec IR and datatype model.

`tigrbl_rs_spec` is part of the Tigrbl Rust package graph. It documents crate-resident runtime, kernel, atom, port, operation, or engine behavior while cross-linking to the Python facade and sibling Rust crates.

## Crate ownership

- Rust AppSpec and IR contracts, datatype semantics, binding envelopes, request/response models, and spec serialization boundaries.
...
```toml
[dependencies]
tigrbl_rs_spec = "0.4.0-dev.2"
```

## Package discovery

Search and AI discovery terms for `tigrbl_rs_spec` include: Tigrbl, Rust, crate, runtime, kernel, atoms, ports, engines, operations, REST, JSON-RPC, schema-first APIs.
...
- crate path: `https://github.com/tigrbl/tigrbl/tree/master/crates/tigrbl_rs_spec`
