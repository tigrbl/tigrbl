...
<a href="https://github.com/tigrbl/tigrbl/blob/master/pkgs/80_facade/tigrbl/README.md"><img src="https://hits.sh/github.com/tigrbl/tigrbl/blob/master/pkgs/80_facade/tigrbl/README.md.svg?label=hits" alt="Repository hits for tigrbl README"/></a>
...
`tigrbl` lives at `pkgs/80_facade/tigrbl` and serves schema-first service authoring, REST, JSON-RPC, streaming, SSE, WebSocket, WebTransport-aware runtime planning, docs, engines, and CLI workflows.
...
| Repository path | [`pkgs/80_facade/tigrbl`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/80_facade/tigrbl) |
...
- Repository: [pkgs/80_facade/tigrbl](https://github.com/tigrbl/tigrbl/tree/master/pkgs/80_facade/tigrbl).
