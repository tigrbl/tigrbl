...
<a href="https://discord.gg/K4YTAPapjR"><img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_engine_numpy"/></a>
<a href="https://github.com/tigrbl/tigrbl/blob/master/pkgs/90_engines/tigrbl_engine_numpy/README.md"><img src="https://hits.sh/github.com/tigrbl/tigrbl/blob/master/pkgs/90_engines/tigrbl_engine_numpy/README.md.svg?label=hits" alt="Repository hits for tigrbl_engine_numpy README"/></a>
<a href="LICENSE"><img src="https://img.shields.io/badge/license-Apache%202.0-525252" alt="Apache 2.0 license"/></a>
<a href="pyproject.toml"><img src="https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13%20%7C%203.14-3776ab" alt="Python versions 3.10 | 3.11 | 3.12 | 3.13 | 3.14 for tigrbl_engine_numpy"/></a>
...
## Who is tigrbl_engine_numpy for?

Application developers, data platform engineers, and operators choosing concrete persistence or data-plane behavior.

## Where does tigrbl_engine_numpy fit?

`tigrbl_engine_numpy` lives at `pkgs/90_engines/tigrbl_engine_numpy` and serves a focused Tigrbl backend integration.

## How does tigrbl_engine_numpy work?
...
| Surface | Value |
|---|---|
| PyPI package | [`tigrbl_engine_numpy`](https://pypi.org/project/tigrbl_engine_numpy/) |
| Repository path | [`pkgs/90_engines/tigrbl_engine_numpy`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/90_engines/tigrbl_engine_numpy) |
| Python import root | `tigrbl_engine_numpy` |
...
`tigrbl_engine_numpy` owns the `engine plugin` boundary. It should be installed when you need this package's focused responsibility without assuming every other Tigrbl workspace package is present.

Implementation orientation:
- `tigrbl_engine_numpy`: engine, session

## Public API and Import Surface

- Import roots: `tigrbl_engine_numpy`.
- Public symbols: `NumpyEngine`, `NumpySession`, `numpy_capabilities`, `numpy_engine`, `register`.
- Workspace dependencies: [`tigrbl`](https://pypi.org/project/tigrbl/).
- External runtime dependencies: `numpy>=1.26`.
...
```bash
python -m pip show tigrbl_engine_numpy
python - <<'PY'
from importlib.metadata import version
print(version("tigrbl_engine_numpy"))
PY
```
...
```python
from tigrbl_engine_numpy import register
...
for entry_point in entry_points(group="tigrbl.engine"):
    if entry_point.module.startswith("tigrbl_engine_numpy"):
...
```bash
uv add tigrbl tigrbl_engine_numpy
pip install tigrbl tigrbl_engine_numpy
```

## How To Choose This Package

Choose `tigrbl_engine_numpy` when the quick-answer table matches your use case. Choose [`tigrbl`](https://pypi.org/project/tigrbl/) instead when you want the full public facade. Choose a lower-level package such as [`tigrbl-core`](https://pypi.org/project/tigrbl-core/), [`tigrbl-base`](https://pypi.org/project/tigrbl-base/), or [`tigrbl-runtime`](https://pypi.org/project/tigrbl-runtime/) when you are building framework extensions or testing a specific internal boundary.
...
- Repository: [pkgs/90_engines/tigrbl_engine_numpy](https://github.com/tigrbl/tigrbl/tree/master/pkgs/90_engines/tigrbl_engine_numpy).

## Package-local Boundary

This README is the package-local distribution entry point for `tigrbl_engine_numpy`. It answers install, usage, API, ownership, and certification-orientation questions for this package. Broader architectural decisions, release status, and cross-package proof chains remain in the repository-level docs and SSOT registry.
