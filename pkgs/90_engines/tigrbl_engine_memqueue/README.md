...
<a href="https://discord.gg/K4YTAPapjR"><img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_engine_memqueue"/></a>
<a href="https://github.com/tigrbl/tigrbl/blob/master/pkgs/90_engines/tigrbl_engine_memqueue/README.md"><img src="https://hits.sh/github.com/tigrbl/tigrbl/blob/master/pkgs/90_engines/tigrbl_engine_memqueue/README.md.svg?label=hits" alt="Repository hits for tigrbl_engine_memqueue README"/></a>
<a href="LICENSE"><img src="https://img.shields.io/badge/license-Apache%202.0-525252" alt="Apache 2.0 license"/></a>
<a href="pyproject.toml"><img src="https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13%20%7C%203.14-3776ab" alt="Python versions 3.10 | 3.11 | 3.12 | 3.13 | 3.14 for tigrbl_engine_memqueue"/></a>
...
## Who is tigrbl_engine_memqueue for?

Application developers, data platform engineers, and operators choosing concrete persistence or data-plane behavior.

## Where does tigrbl_engine_memqueue fit?

`tigrbl_engine_memqueue` lives at `pkgs/90_engines/tigrbl_engine_memqueue` and serves process-local in-memory runtime behavior.

## How does tigrbl_engine_memqueue work?
...
| Surface | Value |
|---|---|
| PyPI package | [`tigrbl_engine_memqueue`](https://pypi.org/project/tigrbl_engine_memqueue/) |
| Repository path | [`pkgs/90_engines/tigrbl_engine_memqueue`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/90_engines/tigrbl_engine_memqueue) |
| Python import root | `tigrbl_engine_memqueue` |
...
`tigrbl_engine_memqueue` owns the `engine plugin` boundary. It should be installed when you need this package's focused responsibility without assuming every other Tigrbl workspace package is present.

Implementation orientation:
- `tigrbl_engine_memqueue`: plugin, queuehub, session

## Public API and Import Surface

- Import roots: `tigrbl_engine_memqueue`.
...
```bash
python -m pip show tigrbl_engine_memqueue
python - <<'PY'
from importlib.metadata import version
print(version("tigrbl_engine_memqueue"))
PY
```
...
```python
from tigrbl_engine_memqueue.plugin import register
...
for entry_point in entry_points(group="tigrbl.engine"):
    if entry_point.module.startswith("tigrbl_engine_memqueue"):
...
```bash
uv add tigrbl tigrbl_engine_memqueue
pip install tigrbl tigrbl_engine_memqueue
```

## How To Choose This Package

Choose `tigrbl_engine_memqueue` when the quick-answer table matches your use case. Choose [`tigrbl`](https://pypi.org/project/tigrbl/) instead when you want the full public facade. Choose a lower-level package such as [`tigrbl-core`](https://pypi.org/project/tigrbl-core/), [`tigrbl-base`](https://pypi.org/project/tigrbl-base/), or [`tigrbl-runtime`](https://pypi.org/project/tigrbl-runtime/) when you are building framework extensions or testing a specific internal boundary.
...
- Repository: [pkgs/90_engines/tigrbl_engine_memqueue](https://github.com/tigrbl/tigrbl/tree/master/pkgs/90_engines/tigrbl_engine_memqueue).
