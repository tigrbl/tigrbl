...
<a href="https://github.com/tigrbl/tigrbl/blob/master/pkgs/90_engines/tigrbl_engine_duckdb/README.md"><img src="https://hits.sh/github.com/tigrbl/tigrbl/blob/master/pkgs/90_engines/tigrbl_engine_duckdb/README.md.svg?label=hits" alt="Repository hits for tigrbl_engine_duckdb README"/></a>
...
`tigrbl_engine_duckdb` lives at `pkgs/90_engines/tigrbl_engine_duckdb` and serves embedded analytical SQL and local OLAP workflows.
...
| Repository path | [`pkgs/90_engines/tigrbl_engine_duckdb`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/90_engines/tigrbl_engine_duckdb) |
...
- Repository: [pkgs/90_engines/tigrbl_engine_duckdb](https://github.com/tigrbl/tigrbl/tree/master/pkgs/90_engines/tigrbl_engine_duckdb).
