"""FastAPI implementation for the OltpTable Widget route surface."""
...
@app.get("/widgetoltptable", response_model=list[WidgetOut])
...
@app.post("/widgetoltptable", response_model=WidgetOut, status_code=201)
...
@app.get("/widgetoltptable/{item_id}", response_model=WidgetOut)
...
@app.patch("/widgetoltptable/{item_id}", response_model=WidgetOut)
...
@app.put("/widgetoltptable/{item_id}", response_model=WidgetOut)
