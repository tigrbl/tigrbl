"""Runtime proof for the OltpTable table-class route surface."""
...
ROUTES = (('/widgetoltptable', ('GET', 'POST')), ('/widgetoltptable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the OltpTable route surface."""
