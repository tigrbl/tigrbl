"""FastAPI implementation for the WebTransportBidiTable Widget route surface."""
...
@app.get("/widgetwebtransportbiditable", response_model=list[WidgetOut])
...
@app.post("/widgetwebtransportbiditable", response_model=WidgetOut, status_code=201)
