"""Runtime proof for the TableBase table-class route surface."""
...
ROUTES = (('/widgettablebase', ('GET', 'POST', 'DELETE')), ('/widgettablebase/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the TableBase route surface."""
