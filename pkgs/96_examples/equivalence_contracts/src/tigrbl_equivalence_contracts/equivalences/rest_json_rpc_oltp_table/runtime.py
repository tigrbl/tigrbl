"""Runtime proof for the RestJsonRpcOltpTable REST and JSON-RPC surfaces."""
...
RPC_PATH = "/rpc"
METHOD_PREFIX = "WidgetRestJsonRpcOltpTable"
ROUTES = (
    ("/widgetrestjsonrpcoltptable", ("GET", "POST")),
    ("/widgetrestjsonrpcoltptable/{item_id}", ("GET", "PATCH", "PUT", "DELETE")),
)
