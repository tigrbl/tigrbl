"""Runtime proof for the RestOlapTable table-class route surface."""
...
ROUTES = (('/widgetrestolaptable', ('GET', 'POST')), ('/widgetrestolaptable/{item_id}', ('GET',)))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the RestOlapTable route surface."""
