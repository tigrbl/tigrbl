"""Runtime proof for the OlapTable table-class route surface."""
...
ROUTES = (('/widgetolaptable', ('GET', 'POST')), ('/widgetolaptable/{item_id}', ('GET',)))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the OlapTable route surface."""
