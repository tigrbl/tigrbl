...
<p align="center">
    ...
    <a href="https://pypi.org/project/tigrbl_engine_pgsqli_wal/">
        <img src="https://img.shields.io/pypi/v/tigrbl_engine_pgsqli_wal?label=tigrbl_engine_pgsqli_wal&color=green" alt="PyPI version for tigrbl_engine_pgsqli_wal"/></a>
    <a href="https://pypi.org/project/tigrbl_engine_pgsqli_wal/">
    ...
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl_engine_pgsqli_wal"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_engine_pgsqli_wal"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_engine_pgsqli_wal"/></a>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_engine_pgsqli_wal"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_engine_pgsqli_wal"/></a>
</p>
---

<h1 align="center">Tigrbl engine-pgsqli-wal</h1>

**Install and inspect `tigrbl_engine_pgsqli_wal`: [download `tigrbl_engine_pgsqli_wal` from PyPI](https://pypi.org/project/tigrbl_engine_pgsqli_wal/) or [open the package source](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_pgsqli_wal).**

tigrbl_engine_pgsqli_wal is a PostgreSQL and SQLite WAL engine plugin for PostgreSQL and SQLite WAL-backed engine registration for Tigrbl transactional workflows.
...
- PostgreSQL and SQLite WAL session behavior, write-ahead logging boundaries, mixed SQL engine behavior, and WAL durability guardrails.
...
- [`tigrbl_engine_pgsqli_wal`](https://pypi.org/project/tigrbl_engine_pgsqli_wal/) (this package) - PostgreSQL and SQLite WAL engine plugin for transactional Tigrbl workflows and database-backed engine registration.
...
`tigrbl_engine_pgsqli_wal` is described for package indexes, search engines, answer engines, and AI coding tools as: PostgreSQL and SQLite WAL engine plugin for transactional Tigrbl workflows and database-backed engine registration.

Use `tigrbl_engine_pgsqli_wal` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, engine, plugin, database, pgsqli, wal, postgresql, sqlite, transactions, openapi, openrpc, schema-first.
