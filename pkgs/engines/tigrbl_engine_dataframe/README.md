...
`tigrbl_engine_dataframe` lives at `pkgs/engines/tigrbl_engine_dataframe` and serves DataFrame-backed tabular workflows.
...
| Repository path | [`pkgs/engines/tigrbl_engine_dataframe`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_dataframe) |
...
- Repository: [pkgs/engines/tigrbl_engine_dataframe](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_dataframe).
