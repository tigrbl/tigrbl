...
`tigrbl_engine_bigquery` lives at `pkgs/engines/tigrbl_engine_bigquery` and serves Google BigQuery warehouse-backed analytics.
...
| Repository path | [`pkgs/engines/tigrbl_engine_bigquery`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_bigquery) |
...
- Repository: [pkgs/engines/tigrbl_engine_bigquery](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_bigquery).
