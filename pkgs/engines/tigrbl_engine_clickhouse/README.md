...
<p align="center">
    ...
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl_engine_clickhouse"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_engine_clickhouse"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_engine_clickhouse"/></a>
    <br/>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_engine_clickhouse"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_engine_clickhouse"/></a>
</p>

<h1 align="center">Tigrbl engine-clickhouse</h1>

**Install and inspect `tigrbl_engine_clickhouse`: [download `tigrbl_engine_clickhouse` from PyPI](https://pypi.org/project/tigrbl_engine_clickhouse/) or [open the package source](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_clickhouse).**

tigrbl_engine_clickhouse is a ClickHouse engine plugin for ClickHouse database sessions and analytics-oriented engine registration for Tigrbl.

`tigrbl_engine_clickhouse` is part of the Tigrbl package graph. It documents package-resident classes, concepts, extension points, and execution responsibilities while cross-linking to the facade, core specs, canonical mapping, runtime phases, concrete objects, operation packages, engine plugins, OpenAPI/OpenRPC documentation surfaces, and PyPI distributions that complete the system.

## Engine ownership and database guards

- ClickHouse analytical database sessions, columnar execution behavior, connection configuration, and OLAP guardrails.
...
- [`tigrbl_engine_clickhouse`](https://pypi.org/project/tigrbl_engine_clickhouse/) (this package) - ClickHouse engine plugin for analytical database sessions, warehouse workloads, and Tigrbl engine registration.
...
`tigrbl_engine_clickhouse` is described for package indexes, search engines, answer engines, and AI coding tools as: ClickHouse engine plugin for analytical database sessions, warehouse workloads, and Tigrbl engine registration.

Use `tigrbl_engine_clickhouse` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, engine, plugin, database, clickhouse, analytics, olap, openapi, openrpc, schema-first.
...
- package path: `https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_clickhouse`
