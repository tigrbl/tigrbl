...
`tigrbl_engine_redis` lives at `pkgs/engines/tigrbl_engine_redis` and serves Redis-backed cache and data-structure workflows.
...
| Repository path | [`pkgs/engines/tigrbl_engine_redis`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_redis) |
...
- Repository: [pkgs/engines/tigrbl_engine_redis](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_redis).
