...
<p align="center">
    <a href="https://pepy.tech/project/tigrbl_engine_memlru">
        <img src="https://static.pepy.tech/badge/tigrbl_engine_memlru" alt="Pepy downloads for tigrbl_engine_memlru"/></a>
    <a href="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memlru/">
        <img src="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memlru.svg" alt="Repository views for tigrbl_engine_memlru"/></a>
    <a href="https://pypi.org/project/tigrbl_engine_memlru/">
        <img src="https://img.shields.io/pypi/v/tigrbl_engine_memlru?label=tigrbl_engine_memlru&color=green" alt="PyPI version for tigrbl_engine_memlru"/></a>
    <a href="https://pypi.org/project/tigrbl_engine_memlru/">
        <img src="https://img.shields.io/pypi/l/tigrbl_engine_memlru" alt="PyPI license metadata for tigrbl_engine_memlru"/></a>
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl_engine_memlru"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_engine_memlru"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_engine_memlru"/></a>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_engine_memlru"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_engine_memlru"/></a>
</p>
---

<h1 align="center">Tigrbl engine-memlru</h1>

**Install and inspect `tigrbl_engine_memlru`: [download `tigrbl_engine_memlru` from PyPI](https://pypi.org/project/tigrbl_engine_memlru/) or [open the package source](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memlru).**

tigrbl_engine_memlru is an in-memory LRU engine plugin for process-local least-recently-used cache behavior for Tigrbl workflows.
...
- process-local least-recently-used eviction, memory cache sizing, and eviction guardrails.
...
- [`tigrbl_engine_memlru`](https://pypi.org/project/tigrbl_engine_memlru/) (this package) - In-memory LRU engine plugin for least-recently-used cache behavior and process-local Tigrbl data workflows.
...
```bash
pip install tigrbl_engine_memlru
```

## Package discovery

`tigrbl_engine_memlru` is described for package indexes, search engines, answer engines, and AI coding tools as: In-memory LRU engine plugin for least-recently-used cache behavior and process-local Tigrbl data workflows.

Use `tigrbl_engine_memlru` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, engine, plugin, database, memlru, lru, cache, inmemory, openapi, openrpc, schema-first.
...
- package path: `https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memlru`
- workspace path: `pkgs/engines/tigrbl_engine_memlru`
- workspace class: engine package
- implementation layout: `src/tigrbl_engine_memlru/`
