...
`tigrbl_engine_numpy` lives at `pkgs/engines/tigrbl_engine_numpy` and serves a focused Tigrbl backend integration.
...
| Repository path | [`pkgs/engines/tigrbl_engine_numpy`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_numpy) |
...
- Repository: [pkgs/engines/tigrbl_engine_numpy](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_numpy).
