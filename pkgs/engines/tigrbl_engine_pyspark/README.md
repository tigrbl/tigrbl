...
<p align="center">
    <a href="https://pepy.tech/project/tigrbl_engine_pyspark">
        <img src="https://static.pepy.tech/badge/tigrbl_engine_pyspark" alt="Pepy downloads for tigrbl_engine_pyspark"/></a>
    <a href="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_pyspark/">
        <img src="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_pyspark.svg" alt="Repository views for tigrbl_engine_pyspark"/></a>
    <a href="https://pypi.org/project/tigrbl_engine_pyspark/">
        <img src="https://img.shields.io/pypi/v/tigrbl_engine_pyspark?label=tigrbl_engine_pyspark&color=green" alt="PyPI version for tigrbl_engine_pyspark"/></a>
    <a href="https://pypi.org/project/tigrbl_engine_pyspark/">
        <img src="https://img.shields.io/pypi/l/tigrbl_engine_pyspark" alt="PyPI license metadata for tigrbl_engine_pyspark"/></a>
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl_engine_pyspark"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_engine_pyspark"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_engine_pyspark"/></a>
    <br/>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_engine_pyspark"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_engine_pyspark"/></a>
</p>

<h1 align="center">Tigrbl engine-pyspark</h1>

**Install and inspect `tigrbl_engine_pyspark`: [download `tigrbl_engine_pyspark` from PyPI](https://pypi.org/project/tigrbl_engine_pyspark/) or [open the package source](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_pyspark).**

tigrbl_engine_pyspark is a PySpark engine plugin for PySpark DataFrame integration for distributed Tigrbl analytics workflows.
...
- PySpark DataFrame integration, distributed analytics setup, session handoff, and cluster execution guardrails.
...
- [`tigrbl_engine_pyspark`](https://pypi.org/project/tigrbl_engine_pyspark/) (this package) - PySpark engine plugin for distributed DataFrame integration, analytics workloads, and Tigrbl data workflows.
...
`tigrbl_engine_pyspark` is described for package indexes, search engines, answer engines, and AI coding tools as: PySpark engine plugin for distributed DataFrame integration, analytics workloads, and Tigrbl data workflows.

Use `tigrbl_engine_pyspark` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, engine, plugin, database, pyspark, spark, distributed, analytics, openapi, openrpc, schema-first.
...
- package path: `https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_pyspark`
