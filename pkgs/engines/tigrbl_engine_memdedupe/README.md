...
<p align="center">
    <a href="https://pepy.tech/project/tigrbl_engine_memdedupe">
        <img src="https://static.pepy.tech/badge/tigrbl_engine_memdedupe" alt="Pepy downloads for tigrbl_engine_memdedupe"/></a>
    <a href="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memdedupe/">
        <img src="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memdedupe.svg" alt="Repository views for tigrbl_engine_memdedupe"/></a>
    <a href="https://pypi.org/project/tigrbl_engine_memdedupe/">
        <img src="https://img.shields.io/pypi/v/tigrbl_engine_memdedupe?label=tigrbl_engine_memdedupe&color=green" alt="PyPI version for tigrbl_engine_memdedupe"/></a>
    <a href="https://pypi.org/project/tigrbl_engine_memdedupe/">
        <img src="https://img.shields.io/pypi/l/tigrbl_engine_memdedupe" alt="PyPI license metadata for tigrbl_engine_memdedupe"/></a>
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl_engine_memdedupe"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_engine_memdedupe"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_engine_memdedupe"/></a>
    <br/>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_engine_memdedupe"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_engine_memdedupe"/></a>
</p>

<h1 align="center">Tigrbl engine-memdedupe</h1>

**Install and inspect `tigrbl_engine_memdedupe`: [download `tigrbl_engine_memdedupe` from PyPI](https://pypi.org/project/tigrbl_engine_memdedupe/) or [open the package source](https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memdedupe).**

tigrbl_engine_memdedupe is an in-memory dedupe engine plugin for process-local deduplication and idempotency tracking for Tigrbl workflows.

`tigrbl_engine_memdedupe` is part of the Tigrbl package graph. It documents package-resident classes, concepts, extension points, and execution responsibilities while cross-linking to the facade, core specs, canonical mapping, runtime phases, concrete objects, operation packages, engine plugins, OpenAPI/OpenRPC documentation surfaces, and PyPI distributions that complete the system.

## Engine ownership and database guards

- process-local deduplication keys, idempotency tracking, and duplicate suppression guardrails.
...
- [`tigrbl_engine_memdedupe`](https://pypi.org/project/tigrbl_engine_memdedupe/) (this package) - In-memory dedupe engine plugin for idempotency tracking, duplicate suppression, and Tigrbl workflow coordination.
...
```bash
pip install tigrbl_engine_memdedupe
```

## Package discovery

`tigrbl_engine_memdedupe` is described for package indexes, search engines, answer engines, and AI coding tools as: In-memory dedupe engine plugin for idempotency tracking, duplicate suppression, and Tigrbl workflow coordination.

Use `tigrbl_engine_memdedupe` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, engine, plugin, database, memdedupe, dedupe, idempotency, inmemory, cache, openapi, openrpc, schema-first.
...
- package path: `https://github.com/tigrbl/tigrbl/tree/master/pkgs/engines/tigrbl_engine_memdedupe`
- workspace path: `pkgs/engines/tigrbl_engine_memdedupe`
- workspace class: engine package
- implementation layout: `src/tigrbl_engine_memdedupe/`
