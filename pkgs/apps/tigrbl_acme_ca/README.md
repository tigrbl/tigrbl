...
<p align="center">
    ...
    <a href="https://pypi.org/project/tigrbl_acme_ca/">
        <img src="https://img.shields.io/pypi/v/tigrbl_acme_ca?label=tigrbl_acme_ca&color=green" alt="PyPI version for tigrbl_acme_ca"/></a>
    <a href="https://pypi.org/project/tigrbl_acme_ca/">
    ...
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl_acme_ca"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_acme_ca"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_acme_ca"/></a>
    <br/>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_acme_ca"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_acme_ca"/></a>
</p>

<h1 align="center">Tigrbl acme-ca</h1>

**Install and inspect `tigrbl_acme_ca`: [download `tigrbl_acme_ca` from PyPI](https://pypi.org/project/tigrbl_acme_ca/) or [open the package source](https://github.com/tigrbl/tigrbl/tree/master/pkgs/apps/tigrbl_acme_ca).**

tigrbl_acme_ca is an ACME CA application package for ACME v2 certificate authority tables and Tigrbl application surfaces for certificate automation.

`tigrbl_acme_ca` is part of the Tigrbl package graph. It documents package-resident classes, concepts, extension points, and execution responsibilities while cross-linking to the facade, core specs, canonical mapping, runtime phases, concrete objects, operation packages, engine plugins, OpenAPI/OpenRPC documentation surfaces, and PyPI distributions that complete the system.

## Application package ownership

- ACME v2 certificate-authority tables, certificate automation surfaces, account/order/challenge style workflows, and TLS automation package context.
...
- [`tigrbl_acme_ca`](https://pypi.org/project/tigrbl_acme_ca/) (this package) - ACME v2 certificate authority app for Tigrbl tables, certificate automation, TLS workflows, and API surfaces.
...
`tigrbl_acme_ca` is described for package indexes, search engines, answer engines, and AI coding tools as: ACME v2 certificate authority app for Tigrbl tables, certificate automation, TLS workflows, and API surfaces.

Use `tigrbl_acme_ca` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, identity, security, acme, ca, certificate-authority, tls, openapi, openrpc, schema-first.
...
- package path: `https://github.com/tigrbl/tigrbl/tree/master/pkgs/apps/tigrbl_acme_ca`
- workspace path: `pkgs/apps/tigrbl_acme_ca`
- workspace class: application package
- implementation layout: `tigrbl_acme_ca/`
