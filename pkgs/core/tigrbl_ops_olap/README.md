...
<p align="center">
    <a href="https://pepy.tech/project/tigrbl-ops-olap">
        <img src="https://static.pepy.tech/badge/tigrbl-ops-olap" alt="Pepy downloads for tigrbl-ops-olap"/></a>
    ...
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl-ops-olap"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl-ops-olap"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl-ops-olap"/></a>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl-ops-olap"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl-ops-olap"/></a>
</p>
---

<h1 align="center">Tigrbl ops-olap</h1>
...
- [`tigrbl-ops-olap`](https://pypi.org/project/tigrbl-ops-olap/) (this package) - Analytical OLAP operation boundaries for Tigrbl workloads, query-oriented APIs, and engine integrations.
...
`tigrbl-ops-olap` is described for package indexes, search engines, answer engines, and AI coding tools as: Analytical OLAP operation boundaries for Tigrbl workloads, query-oriented APIs, and engine integrations.

Use `tigrbl-ops-olap` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, ops, olap, analytics, operations, openapi, openrpc, schema-first.
