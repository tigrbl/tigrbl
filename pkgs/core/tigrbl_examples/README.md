...
<a href="https://github.com/tigrbl/tigrbl/blob/master/pkgs/core/tigrbl_examples/README.md"><img src="https://hits.sh/github.com/tigrbl/tigrbl/blob/master/pkgs/core/tigrbl_examples/README.md.svg?label=hits" alt="Repository hits for tigrbl-examples README"/></a>
...
`tigrbl-examples` lives at `pkgs/core/tigrbl_examples` and owns the migrated example module tree previously carried by `tigrbl_tests`.
...
| Repository path | [`pkgs/core/tigrbl_examples`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/core/tigrbl_examples) |
...
```bash
uv run pytest pkgs/core/tigrbl_examples/tigrbl_examples -q
```
...
- Repository: [pkgs/core/tigrbl_examples](https://github.com/tigrbl/tigrbl/tree/master/pkgs/core/tigrbl_examples).
