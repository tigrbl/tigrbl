...
<a href="https://github.com/tigrbl/tigrbl/blob/master/pkgs/core/tigrbl_canon/README.md"><img src="https://hits.sh/github.com/tigrbl/tigrbl/blob/master/pkgs/core/tigrbl_canon/README.md.svg?label=hits" alt="Repository hits for tigrbl-canon README"/></a>
...
<a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md"><img src="https://img.shields.io/badge/workspace-core-1f6feb" alt="Workspace group for tigrbl-canon"/></a>
</div>
...
`tigrbl-canon` owns the canon boundary inside the split Python workspace. Key implementation roots include `tigrbl_canon` with `tigrbl_canon/mapping/`.

## Use It When

Use `tigrbl-canon` when you want this subsystem directly as a package boundary instead of consuming it only through the top-level `tigrbl` facade.
