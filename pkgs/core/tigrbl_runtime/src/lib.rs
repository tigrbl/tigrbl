...
pub fn compile_spec(spec_json: &str) -> RustResult<String> {
...
pub fn create_runtime_handle(spec_json: &str) -> RustResult<runtime_handle::RuntimeHandle> {
    runtime_handle::create_runtime_handle(spec_json)
}

pub fn register_python_callback(name: &str) -> RustResult<String> {
    callback_registry::record_event(
...
pub fn register_python_atom(name: &str) -> RustResult<String> {
    Ok(py_atoms::register_python_atom(name))
}

pub fn register_python_hook(name: &str) -> RustResult<String> {
    Ok(py_hooks::register_python_hook(name))
}

pub fn register_python_handler(name: &str) -> RustResult<String> {
    Ok(py_handlers::register_python_handler(name))
}

pub fn register_python_engine(name: &str) -> RustResult<String> {
