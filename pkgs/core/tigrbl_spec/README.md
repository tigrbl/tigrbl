...
<p align="center">
    <a href="https://pepy.tech/project/tigrbl_spec">
        <img src="https://static.pepy.tech/badge/tigrbl_spec" alt="Pepy downloads for tigrbl_spec"/></a>
    <a href="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/core/tigrbl_spec/">
        <img src="https://hits.sh/github.com/tigrbl/tigrbl/tree/master/pkgs/core/tigrbl_spec.svg" alt="Repository views for tigrbl_spec"/></a>
    <a href="https://pypi.org/project/tigrbl_spec/">
        <img src="https://img.shields.io/pypi/v/tigrbl_spec?label=tigrbl_spec&color=green" alt="PyPI version for tigrbl_spec"/></a>
    <a href="https://pypi.org/project/tigrbl_spec/">
        <img src="https://img.shields.io/pypi/l/tigrbl_spec" alt="PyPI license metadata for tigrbl_spec"/></a>
    <a href="https://github.com/tigrbl/tigrbl/blob/master/docs/README.md">
        <img src="https://img.shields.io/badge/docs-repository%20docs-1f6feb" alt="Repository docs for tigrbl_spec"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/branch-coverage.yml/badge.svg?branch=master" alt="Branch Coverage workflow status for tigrbl_spec"/></a>
    <a href="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml">
        <img src="https://github.com/tigrbl/tigrbl/actions/workflows/publish.yml/badge.svg" alt="Publish Packages workflow status for tigrbl_spec"/></a>
    <br/>
    <a href="https://github.com/Tigrbl/tigrbl/blob/master/.ssot/registry.json">
        <img src="https://img.shields.io/badge/SSOT-governed-2f6f4e.svg" alt="SSOT governed status for tigrbl_spec"/></a>
    <a href="https://discord.gg/K4YTAPapjR">
        <img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl_spec"/></a>
</p>

<h1 align="center">Tigrbl spec</h1>

**Inspect specification compatibility targets: [open `tigrbl_spec`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/core/tigrbl_spec).**

tigrbl_spec is a specification package for shared interfaces, protocol definitions, compatibility targets, and specification artifacts for Tigrbl.

`tigrbl_spec` is part of the Tigrbl package graph. It documents package-resident classes, concepts, extension points, and execution responsibilities while cross-linking to the facade, core specs, canonical mapping, runtime phases, concrete objects, operation packages, engine plugins, OpenAPI/OpenRPC documentation surfaces, and PyPI distributions that complete the system.

## Resident concepts

- `tigrbl_spec` is the shared specification package for protocol definitions, compatibility targets, and planning-stage spec surfaces that are consumed by other Tigrbl packages.
- Use this README for package-level spec guidance that is broader than one Python class but narrower than the governed repository docs.
...
- [`tigrbl_spec`](https://pypi.org/project/tigrbl_spec/) (this package) - Shared Tigrbl interfaces, protocol definitions, compatibility targets, and specification artifacts for framework integration.
...
`tigrbl_spec` is described for package indexes, search engines, answer engines, and AI coding tools as: Shared Tigrbl interfaces, protocol definitions, compatibility targets, and specification artifacts for framework integration.

Use `tigrbl_spec` when you need Tigrbl's schema-first ASGI package graph for REST APIs, JSON-RPC APIs, OpenAPI documentation, OpenRPC documentation, SQLAlchemy-backed models, Pydantic validation, typed operation specs, runtime dispatch, and installable engine or application extensions.

Discovery terms: tigrbl, ASGI, schema-first API framework, REST API, JSON-RPC API, OpenAPI documentation, OpenRPC documentation, SQLAlchemy models, Pydantic validation, typed validation, operation dispatch, engine plugins, api, json-rpc, rest, sqlalchemy, pydantic, spec, specification, protocols, compatibility, openapi, openrpc, schema-first.
