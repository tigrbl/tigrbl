...
<a href="https://discord.gg/K4YTAPapjR"><img src="https://img.shields.io/badge/Discord-Join%20chat-5865F2?logo=discord&logoColor=white" alt="Discord community for tigrbl-ops-olap"/></a>
<a href="https://github.com/tigrbl/tigrbl/blob/master/pkgs/60_ops/tigrbl_ops_olap/README.md"><img src="https://hits.sh/github.com/tigrbl/tigrbl/blob/master/pkgs/60_ops/tigrbl_ops_olap/README.md.svg?label=hits" alt="Repository hits for tigrbl-ops-olap README"/></a>
<a href="LICENSE"><img src="https://img.shields.io/badge/license-Apache%202.0-525252" alt="Apache 2.0 license"/></a>
<a href="pyproject.toml"><img src="https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13%20%7C%203.14-3776ab" alt="Python versions 3.10 | 3.11 | 3.12 | 3.13 | 3.14 for tigrbl-ops-olap"/></a>
...
`tigrbl-ops-olap` lives at `pkgs/60_ops/tigrbl_ops_olap` and serves focused operation dispatch behavior inside the Tigrbl runtime model.
...
| Surface | Value |
|---|---|
| PyPI package | [`tigrbl-ops-olap`](https://pypi.org/project/tigrbl-ops-olap/) |
| Repository path | [`pkgs/60_ops/tigrbl_ops_olap`](https://github.com/tigrbl/tigrbl/tree/master/pkgs/60_ops/tigrbl_ops_olap) |
...
- Repository: [pkgs/60_ops/tigrbl_ops_olap](https://github.com/tigrbl/tigrbl/tree/master/pkgs/60_ops/tigrbl_ops_olap).
