    ...
    return [
        CommandTask(
            ...
            argv=_python_command(
                "pkgs/97_tests/tigrbl_tests/benchmarks/tigrbl_kernel_plan_benchmark.py",
                "--output",
        ...
        CommandTask(
            ...
            argv=_python_command(
                "-m",
                "pytest",
                "pkgs/97_tests/tigrbl_tests/tests/perf/test_tigrbl_vs_fastapi_create_benchmark.py::test_tigrbl_vs_fastapi_sequential_10_rounds_randomized_comparison",
                "-q",
            ),
            artifact_paths=(
        ...
        CommandTask(
            ...
            argv=_python_command(
                "-m",
                "pytest",
                "pkgs/97_tests/tigrbl_tests/tests/perf/test_tigrbl_vs_fastapi_create_benchmark.py::test_tigrbl_vs_fastapi_sequential_10_rounds_randomized_comparison_250_ops",
                "-q",
            ),
            artifact_paths=(
                PERF_DIR / "benchmark_results_create_uvicorn.json",
        ...
        CommandTask(
            ...
            argv=_python_command(
                "-m",
                "pytest",
                "pkgs/97_tests/tigrbl_tests/tests/perf/test_tigrbl_vs_fastapi_create_benchmark.py::test_tigrbl_vs_fastapi_asgitransport_sequential_10_rounds_randomized_comparison_250_ops",
                "-q",
            ),
            artifact_paths=(
        ...
        CommandTask(
            ...
            argv=_python_command(
                "-m",
                "pytest",
                "pkgs/97_tests/tigrbl_tests/tests/perf/test_tigrbl_vs_fastapi_create_benchmark.py::test_tigrbl_vs_fastapi_httpxtransport_sequential_10_rounds_randomized_comparison_250_ops",
                "-q",
            ),
            artifact_paths=(
                PERF_DIR / "benchmark_results_create_httpxtransport_sequential_10_rounds_250_ops.json",
        ...
        CommandTask(
            ...
            argv=_python_command(
                "-m",
                "pytest",
                "pkgs/97_tests/tigrbl_tests/tests/perf/test_tigrbl_create_call_graph.py",
                "-q",
            ),
        ...
        CommandTask(
            ...
            argv=_python_command(
                "-m",
                "pytest",
                "pkgs/97_tests/tigrbl_tests/tests/perf/test_fastapi_create_call_graph.py",
                "-q",
            ),
        ...
        CommandTask(
            ...
            argv=_python_command(
                "pkgs/97_tests/tigrbl_tests/benchmarks/tigrbl_streaming_perf_suite.py",
            ),
            artifact_paths=(
        ...
        CommandTask(
            ...
            argv=_python_command(
                "pkgs/97_tests/tigrbl_tests/benchmarks/tigrbl_websocket_perf_suite.py",
            ),
            artifact_paths=(
        ...
        CommandTask(
            name="sse_perf_suite",
            argv=_python_command(
                "pkgs/97_tests/tigrbl_tests/benchmarks/tigrbl_sse_perf_suite.py",
            ),
            artifact_paths=(
                SSE_RESULTS_JSON,
                SSE_KERNEL_JSON,
        ...
        CommandTask(
            ...
            argv=_python_command(
                "pkgs/97_tests/tigrbl_tests/benchmarks/tigrbl_webtransport_perf_suite.py",
            ),
            artifact_paths=(
