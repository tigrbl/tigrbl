...
| `sql.sqlite-table` | sql | Declare the same Item table shape for SQLite-backed persistence. | `projection-only` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
