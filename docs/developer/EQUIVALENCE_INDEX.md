...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `app.http-health` | application | Author a simple GET endpoint returning a stable JSON payload. | `equivalent` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
| `router.prefix-read` | router | Group a read endpoint under a versioned router or blueprint prefix. | `analogous` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
| `table.resource-contract` | table | Declare an Item resource with id/name fields and create/list/read operations. | `analogous` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
| `websocket.echo-contract` | transport | Declare a WebSocket echo channel with JSON text framing. | `projection-only` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
| `sql.logical-datatype-lowering` | sql | Track logical field types separately from engine-specific SQL lowerings. | `projection-only` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
