...
Source inputs: `examples/equivalence_contracts/src/tigrbl_equivalence_contracts/contracts.py`, `examples/equivalence_contracts/src/tigrbl_equivalence_contracts/frameworks/`, `examples/equivalence_contracts/tests/test_certifiable_equivalences.py`.

| Equivalence ID | Category | Intent | Status | Tigrbl code | FastAPI code | Flask code | Parity test |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `rest-crud.widget` | rest-crud | Author REST CRUD for a Widget resource with id and name columns. | `analogous` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
| `table-class.table-base` | table-class | Author a Widget resource with Tigrbl TableBase and compare its projected route surface to FastAPI and Flask. | `analogous` | `src/tigrbl_equivalence_contracts/frameworks/tigrbl_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/fastapi_impl.py` | `src/tigrbl_equivalence_contracts/frameworks/flask_impl.py` | `examples/equivalence_contracts/tests/test_certifiable_equivalences.py` |
