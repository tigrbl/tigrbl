...
- Certifiable equivalence runtime demos live in `pkgs/96_examples/equivalence_contracts` and are checked by `tools/ci/validate_equivalence_runtime_contracts.py`
