...
3. Rust compiles the kernel plan, instantiates the native runtime, and serves requests.
...
This keeps the steady-state request path native whenever the plan is composed entirely of Rust-native atoms, handlers, and engines.
