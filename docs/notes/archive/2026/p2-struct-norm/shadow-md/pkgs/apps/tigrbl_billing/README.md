...
<p align="center">
    ...
    <a href="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/apps/tigrbl_billing/">
        <img alt="Hits" src="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/apps/tigrbl_billing.svg"/></a>
    <a href="https://pypi.org/project/tigrbl-billing/">
...
```bash
uv sync
uv run --directory pkgs/apps/tigrbl_billing --package tigrbl-billing ruff format .
uv run --directory pkgs/apps/tigrbl_billing --package tigrbl-billing ruff check .
```
