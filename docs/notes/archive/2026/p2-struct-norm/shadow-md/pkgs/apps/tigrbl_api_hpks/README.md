...
<p align="center">
    ...
    <a href="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/apps/tigrbl_api_hpks/">
        <img alt="Hits" src="https://hits.sh/github.com/swarmauri/swarmauri-sdk/tree/master/pkgs/apps/tigrbl_api_hpks.svg"/></a>
    <a href="https://pypi.org/project/tigrbl_api_hpks/">
...
```bash
uv run --package tigrbl_api_hpks --directory pkgs/apps/tigrbl_api_hpks pytest
```
