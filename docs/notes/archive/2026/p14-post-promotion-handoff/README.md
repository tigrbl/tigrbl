...
- stable release `0.3.18` is frozen as governed release history
- promotion-source dev bundle `0.3.18.dev1` remains unchanged
- active next-line work starts under `0.3.19.dev1`
- next-target datatype/table planning now lives in governed ADR and conformance docs rather than loose WIP notes
