...
This is the Phase 7 governance + spec/security + operator-surface closure claim registry. It records the governance baseline, the core OAS / JSON-RPC / OpenRPC closure from Phase 5, the retained RFC security rows from Phase 6, the Phase 7 docs/operator closure rows, and the still-open CLI row.
...
| GATE-006 | Gate A validation suite passes in the checkpoint tree | verified in checkpoint | Tier 2 | Governance | `docs/conformance/audit/2026/p6-rfc-sec/README.md`, `docs/conformance/audit/2026/phase7-operator-surface/README.md` |
...
| CLI-001 | Unified `tigrbl` CLI row remains open | missing | Tier 0 | CLI / Developer Experience | `docs/developer/CLI_REFERENCE.md` |
