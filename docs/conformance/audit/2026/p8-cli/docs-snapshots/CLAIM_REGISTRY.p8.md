...
| OP-001 | static files surface is verified in checkpoint | verified in checkpoint | Tier 2 | Operator Surface | `pkgs/core/tigrbl_tests/tests/unit/test_operator_surface_closure.py`, `docs/conformance/audit/2026/phase7-operator-surface/phase7_operator_pytest.log` |
| OP-002 | cookies surface is verified in checkpoint | verified in checkpoint | Tier 2 | Operator Surface | `pkgs/core/tigrbl_tests/tests/unit/test_operator_surface_closure.py`, `docs/conformance/audit/2026/phase7-operator-surface/phase7_operator_pytest.log` |
| OP-003 | streaming responses surface is verified in checkpoint | verified in checkpoint | Tier 2 | Operator Surface | `pkgs/core/tigrbl_tests/tests/unit/test_operator_surface_closure.py`, `docs/conformance/audit/2026/phase7-operator-surface/phase7_operator_pytest.log` |
| OP-004 | WebSockets surface is verified in checkpoint | verified in checkpoint | Tier 2 | Operator Surface | `pkgs/core/tigrbl_tests/tests/unit/test_operator_surface_closure.py`, `docs/conformance/audit/2026/phase7-operator-surface/phase7_operator_pytest.log` |
| OP-005 | WHATWG SSE surface is verified in checkpoint | verified in checkpoint | Tier 2 | Operator Surface | `pkgs/core/tigrbl_tests/tests/unit/test_operator_surface_closure.py`, `docs/conformance/audit/2026/phase7-operator-surface/phase7_operator_pytest.log` |
| OP-006 | forms / multipart surface is verified in checkpoint | verified in checkpoint | Tier 2 | Operator Surface | `pkgs/core/tigrbl_tests/tests/unit/test_operator_surface_closure.py`, `docs/conformance/audit/2026/phase7-operator-surface/phase7_operator_pytest.log` |
| OP-007 | upload handling surface is verified in checkpoint | verified in checkpoint | Tier 2 | Operator Surface | `pkgs/core/tigrbl_tests/tests/unit/test_operator_surface_closure.py`, `docs/conformance/audit/2026/phase7-operator-surface/phase7_operator_pytest.log` |
