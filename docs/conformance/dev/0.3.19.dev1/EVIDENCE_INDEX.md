...
|---|---|---|
| Bundle purpose | planning/handoff only | `docs/conformance/dev/0.3.19.dev1/BUILD_NOTES.md` |
| Stable release reference | frozen | `docs/conformance/releases/0.3.18/EVIDENCE_INDEX.md` |
