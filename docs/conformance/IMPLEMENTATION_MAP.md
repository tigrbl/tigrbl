...
| Target | Status | Owner | Code / docs locations | Test evidence | Blocker / gap | Closure path |
|---|---|---|---|---|---|---|
| route/opview/phase-plan parity snapshots | verified in checkpoint | Protocol / RPC Runtime | `bindings/python/tigrbl_native/python/tigrbl_native/_parity_contract.py`, `bindings/python/tigrbl_native/python/tigrbl_native/parity.py`, `crates/tigrbl_rs_kernel/src/parity.rs`, `reports/current_state/2026-04-09-phase4-native-parity.md` | `pkgs/core/tigrbl_tests/tests/native/parity/test_native_parity_contract.py`, `crates/tigrbl_rs_kernel/tests/parity_contract.rs` | snapshot parity is contract-level proof, not full live backend execution parity | preserve the shared parity contract and extend it into compiled-backend execution proof before publishing native claims |
