...
| explicit supported runner set (`tigrcorn`, `uvicorn`, `hypercorn`, `gunicorn`) | implemented on active line | CLI / Developer Experience | `pkgs/core/tigrbl/tigrbl/cli.py`<br>`docs/conformance/NEXT_TARGETS.md` | `pkgs/core/tigrbl_tests/tests/unit/test_phase8_cli_srv.py`<br>`tools/conformance/installed_package_smoke.py` | support is adapter-level governance, not framework-owned transport certification | keep the supported set explicit and reject non-governed server names |

## Explicit server support and exclusions

| Target | Status | Owner | Code locations | Test evidence | Blocker / gap | Closure path |
|---|---|---|---|---|---|---|
| `tigrcorn` supported server runner | implemented on active line | CLI / Developer Experience | `pkgs/core/tigrbl/tigrbl/cli.py`<br>`docs/conformance/NEXT_TARGETS.md` | `pkgs/core/tigrbl_tests/tests/unit/test_phase8_cli_srv.py`<br>`tools/conformance/installed_package_smoke.py` | support is bounded to governed runner dispatch/config translation | keep support explicit without overstating transport ownership |
| `uvicorn` supported server runner | implemented on active line | CLI / Developer Experience | `pkgs/core/tigrbl/tigrbl/cli.py`<br>`docs/conformance/NEXT_TARGETS.md` | `pkgs/core/tigrbl_tests/tests/unit/test_phase8_cli_srv.py`<br>`tools/conformance/installed_package_smoke.py` | support is bounded to governed runner dispatch/config translation | keep support explicit without overstating transport ownership |
| `hypercorn` supported server runner | implemented on active line | CLI / Developer Experience | `pkgs/core/tigrbl/tigrbl/cli.py`<br>`docs/conformance/NEXT_TARGETS.md` | `pkgs/core/tigrbl_tests/tests/unit/test_phase8_cli_srv.py`<br>`tools/conformance/installed_package_smoke.py` | support is bounded to governed runner dispatch/config translation | keep support explicit without overstating transport ownership |
| `gunicorn` supported server runner | implemented on active line | CLI / Developer Experience | `pkgs/core/tigrbl/tigrbl/cli.py`<br>`docs/conformance/NEXT_TARGETS.md` | `pkgs/core/tigrbl_tests/tests/unit/test_phase8_cli_srv.py`<br>`tools/conformance/installed_package_smoke.py` | support is bounded to governed runner dispatch/config translation | keep support explicit without overstating transport ownership |
| `daphne` server runner | OOB | Server/runtime boundary | `docs/conformance/NEXT_TARGETS.md`<br>`pkgs/core/tigrbl/tigrbl/cli.py` | `pkgs/core/tigrbl_tests/tests/unit/test_phase8_cli_srv.py` | not part of the governed supported runner set | keep out of framework certification claims until separately governed |
