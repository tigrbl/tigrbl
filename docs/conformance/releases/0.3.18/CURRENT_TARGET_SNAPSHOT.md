...
## Certification infrastructure established in Phase 9 and promoted in Phase 13

Phase 9 created the durable evidence model. Phase 13 promotes the exact chosen dev bundle into the current stable release.
