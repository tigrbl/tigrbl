...
from tigrbl_runtime.rust.codec import build_rust_app_spec  # noqa: E402
...
class RustRuntimeDemoApp(AppBase):
    TITLE = "rust_runtime_demo"
    VERSION = "0.1.0"
    DESCRIPTION = "Python-authored Tigrbl AppSpec executed by the Rust runtime."
...
def compose_app_spec() -> AppSpec:
    return AppBase.collect_spec(RustRuntimeDemoApp)


def build_rust_payload() -> dict[str, object]:
    return build_rust_app_spec(compose_app_spec())
