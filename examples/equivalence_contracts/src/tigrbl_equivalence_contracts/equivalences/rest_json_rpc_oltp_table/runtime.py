"""Runtime proof for the RestJsonRpcOltpTable table-class route surface."""
...
ROUTES = (('/widgetrestjsonrpcoltptable', ('GET', 'POST')), ('/widgetrestjsonrpcoltptable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the RestJsonRpcOltpTable route surface."""
