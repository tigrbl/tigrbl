...
CONTRACT = CertifiableEquivalence(
    ...
    intent="Author a Widget resource with Tigrbl RestJsonRpcOltpTable and compare REST routes plus HTTP JSON-RPC OLTP behavior to FastAPI and Flask.",
    status="analogous",
    claim="Tigrbl RestJsonRpcOltpTable, FastAPI routes plus a JSON-RPC endpoint, and Flask routes plus a JSON-RPC endpoint can expose the same Widget REST and OLTP JSON-RPC behavior for the table class.",
