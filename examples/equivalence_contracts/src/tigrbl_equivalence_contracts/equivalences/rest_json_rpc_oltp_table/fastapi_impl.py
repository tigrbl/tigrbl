"""FastAPI implementation for the RestJsonRpcOltpTable Widget route surface."""
...
@app.get("/widgetrestjsonrpcoltptable", response_model=list[WidgetOut])
...
@app.post("/widgetrestjsonrpcoltptable", response_model=WidgetOut, status_code=201)
...
@app.get("/widgetrestjsonrpcoltptable/{item_id}", response_model=WidgetOut)
...
@app.patch("/widgetrestjsonrpcoltptable/{item_id}", response_model=WidgetOut)
...
@app.put("/widgetrestjsonrpcoltptable/{item_id}", response_model=WidgetOut)
