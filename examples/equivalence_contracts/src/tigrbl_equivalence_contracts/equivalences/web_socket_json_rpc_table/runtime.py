"""Runtime proof for the WebSocketJsonRpcTable table-class route surface."""
...
ROUTES = (('/widgetwebsocketjsonrpctable', ('GET', 'POST')), ('/widgetwebsocketjsonrpctable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the WebSocketJsonRpcTable route surface."""
