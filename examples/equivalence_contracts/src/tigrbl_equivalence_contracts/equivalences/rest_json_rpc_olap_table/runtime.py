"""Runtime proof for the RestJsonRpcOlapTable table-class route surface."""
...
ROUTES = (('/widgetrestjsonrpcolaptable', ('GET', 'POST')), ('/widgetrestjsonrpcolaptable/{item_id}', ('GET',)))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the RestJsonRpcOlapTable route surface."""
