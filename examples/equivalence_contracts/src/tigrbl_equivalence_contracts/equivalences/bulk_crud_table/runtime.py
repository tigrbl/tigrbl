"""Runtime proof for the BulkCrudTable table-class route surface."""
...
ROUTES = (('/widgetbulkcrudtable', ('GET', 'POST', 'PATCH', 'PUT', 'DELETE')), ('/widgetbulkcrudtable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the BulkCrudTable route surface."""
