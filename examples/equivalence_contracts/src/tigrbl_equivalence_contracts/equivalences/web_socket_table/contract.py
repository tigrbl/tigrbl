"""Contract row for the WebSocketTable table-class equivalence."""
...
CONTRACT = CertifiableEquivalence(
    ...
    implementations=(
        ...
        _impl("fastapi", "src/tigrbl_equivalence_contracts/equivalences/web_socket_table/fastapi_impl.py", _lazy_attr("equivalences.web_socket_table.fastapi_impl", "app"), "asgi", assert_equivalence, (), lambda result: result),
        _impl("flask", "src/tigrbl_equivalence_contracts/equivalences/web_socket_table/flask_impl.py", _lazy_attr("equivalences.web_socket_table.flask_impl", "app"), "wsgi", assert_equivalence, (), lambda result: result),
    ),
)
