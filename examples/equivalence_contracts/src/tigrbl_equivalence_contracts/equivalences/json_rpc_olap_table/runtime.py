"""Runtime proof for the JsonRpcOlapTable table-class route surface."""
...
ROUTES = (('/widgetjsonrpcolaptable', ('GET', 'POST')), ('/widgetjsonrpcolaptable/{item_id}', ('GET',)))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the JsonRpcOlapTable route surface."""
