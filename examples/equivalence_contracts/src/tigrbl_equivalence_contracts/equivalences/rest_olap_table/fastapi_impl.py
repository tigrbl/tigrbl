"""FastAPI implementation for the RestOlapTable Widget route surface."""
...
@app.get("/widgetrestolaptable", response_model=list[WidgetOut])
...
@app.post("/widgetrestolaptable", response_model=WidgetOut, status_code=201)
...
@app.get("/widgetrestolaptable/{item_id}", response_model=WidgetOut)
