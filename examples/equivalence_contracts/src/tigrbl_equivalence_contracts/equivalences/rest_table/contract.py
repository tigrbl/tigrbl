"""Contract row for the RestTable table-class equivalence."""
...
CONTRACT = CertifiableEquivalence(
    ...
    intent="Author a Widget resource with Tigrbl RestTable and compare its projected route surface to FastAPI and Flask.",
    status="analogous",
    claim="Tigrbl RestTable, FastAPI routes, and Flask routes can expose the same Widget route surface for the table class.",
