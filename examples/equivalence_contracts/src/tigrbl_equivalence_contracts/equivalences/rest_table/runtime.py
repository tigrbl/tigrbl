"""Runtime proof for the RestTable table-class route surface."""
...
ROUTES = (('/widgetresttable', ('GET', 'POST', 'DELETE')), ('/widgetresttable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the RestTable route surface."""
