"""Runtime proof for the JsonRpcBulkCrudTable table-class route surface."""
...
ROUTES = (('/widgetjsonrpcbulkcrudtable', ('GET', 'POST', 'PATCH', 'PUT', 'DELETE')), ('/widgetjsonrpcbulkcrudtable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the JsonRpcBulkCrudTable route surface."""
