"""Runtime proof for the WebTransportServerStreamTable table-class route surface."""
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the WebTransportServerStreamTable route surface."""
