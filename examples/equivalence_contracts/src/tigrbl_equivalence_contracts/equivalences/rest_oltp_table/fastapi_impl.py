"""FastAPI implementation for the RestOltpTable Widget route surface."""
...
@app.get("/widgetrestoltptable", response_model=list[WidgetOut])
...
@app.post("/widgetrestoltptable", response_model=WidgetOut, status_code=201)
...
@app.get("/widgetrestoltptable/{item_id}", response_model=WidgetOut)
...
@app.patch("/widgetrestoltptable/{item_id}", response_model=WidgetOut)
...
@app.put("/widgetrestoltptable/{item_id}", response_model=WidgetOut)
