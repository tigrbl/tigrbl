"""FastAPI implementation for the TableBase Widget route surface."""
...
@app.get("/widgettablebase", response_model=list[WidgetOut])
...
@app.post("/widgettablebase", response_model=WidgetOut, status_code=201)
...
@app.get("/widgettablebase/{item_id}", response_model=WidgetOut)
...
@app.patch("/widgettablebase/{item_id}", response_model=WidgetOut)
...
@app.put("/widgettablebase/{item_id}", response_model=WidgetOut)
