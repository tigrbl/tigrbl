"""Contract row for the JsonRpcOltpTable table-class equivalence."""
...
CONTRACT = CertifiableEquivalence(
    ...
    implementations=(
        ...
        _impl("fastapi", "src/tigrbl_equivalence_contracts/equivalences/json_rpc_oltp_table/fastapi_impl.py", _lazy_attr("equivalences.json_rpc_oltp_table.fastapi_impl", "app"), "asgi", assert_equivalence, (), lambda result: result),
        _impl("flask", "src/tigrbl_equivalence_contracts/equivalences/json_rpc_oltp_table/flask_impl.py", _lazy_attr("equivalences.json_rpc_oltp_table.flask_impl", "app"), "wsgi", assert_equivalence, (), lambda result: result),
    ),
)
