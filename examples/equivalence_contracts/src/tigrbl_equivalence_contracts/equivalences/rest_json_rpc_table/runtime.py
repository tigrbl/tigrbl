"""Runtime proof for the RestJsonRpcTable table-class route surface."""
...
ROUTES = (('/widgetrestjsonrpctable', ('GET', 'POST', 'DELETE')), ('/widgetrestjsonrpctable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the RestJsonRpcTable route surface."""
