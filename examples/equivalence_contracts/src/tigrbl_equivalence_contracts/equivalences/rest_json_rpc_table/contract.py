...
CONTRACT = CertifiableEquivalence(
    ...
    intent="Author a Widget resource with Tigrbl RestJsonRpcTable and compare its projected route surface to FastAPI and Flask.",
    status="analogous",
    claim="Tigrbl RestJsonRpcTable, FastAPI routes, and Flask routes can expose the same Widget route surface for the table class.",
