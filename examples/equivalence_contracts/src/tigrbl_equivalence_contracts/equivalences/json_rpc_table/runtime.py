"""Runtime proof for the JsonRpcTable table-class route surface."""
...
ROUTES = (('/widgetjsonrpctable', ('GET', 'POST', 'DELETE')), ('/widgetjsonrpctable/{item_id}', ('GET', 'PATCH', 'PUT', 'DELETE')))
...
def assert_equivalence(app: Any, server_kind: ServerKind) -> tuple[dict[str, Any], ...]:
    """Start one vendor app and assert the JsonRpcTable route surface."""
